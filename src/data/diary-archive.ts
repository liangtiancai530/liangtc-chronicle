...
const ARCHIVE_RAW: ArchivedDiaryYear[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      {
        id: "2026-09-05",
        date: "Sep 5, 2026 · Saturday",
        body:
          "Today I was deeply shocked to hear that Wangyu He, a 20-year-old student at the University of Toronto, took her own life by jumping from the 32nd floor of a tall building on campus. I can hardly believe it. From her social media accounts, she had apparently been suffering from mental illness — insomnia, difficulty concentrating, and anxiety about everything. Depression is a serious problem that society has not paid sufficient attention to.\n\nWangyu was special to our family because she was my daughter's classmate in primary school, and we knew her well as a little girl and as a teenager in the same community. In May, Tina told us that Wangyu was having mental-health problems and seemed to be performing very badly academically as a sophomore at UT. We regret that her parents did not give her enough attention. I can imagine how devastated they must be now. How can parents overcome such a blow? I hope they will recover soon, although it will not be easy at all.",
      },
      {
        id: "2026-09-06",
        date: "Sep 6, 2026 · Sunday",
        body:
          "Last week my wife told me that Robin's husband, Don Lemon, had died of a heart attack — perhaps an aortic dissection causing massive internal bleeding — at the age of 71. Today I watched Don's funeral commemorating him. From what was said at the funeral, I learned much more about Don, whom I had met once at Beijing Airport ten years ago. Don, as I saw and imagined him, was a person worthy of respect. He was very diligent, intelligent, and warm-hearted toward others. He was a convinced Christian, always active in helping those in need. For example, he did a great deal of volunteer work delivering food and other necessities to people in need. He was so kind to his son, daughters, and grandchildren. Robin and Don had 45 years of marriage and were clearly a very loving couple. Their daughter and son miss their father deeply.\n\nBut I think Don was taken by God very gently. Everyone in the world will pass away, one way or another. To die in a short moment without suffering is, for us, the most admirable way to go. According to Robin's description, Don simply felt tired; minutes later, he lost consciousness and died. He may not have reached the average life expectancy, but a life of long mental or physical suffering is worse than an early death. So Don seems to be among those lucky ones to whom God has shown mercy, at least as far as the manner of his dying is concerned.\n\nAnother thing I find important is that he seemed to be in very good physical shape. He exercised almost every day, and he did not look like someone in his 70s. But a heart attack is so dangerous that there is no time for medical reaction. Heart and cardiovascular disease seem to be the most dangerous illnesses in the world, killing the majority of people.\n\nAnyway, I will send my deep condolences to Robin and her children; but at the same time, I will explain to Robin that her husband's passing is a happy ending for him, and the best reward for a devout Christian. Amen!",
      },
      {
        id: "2026-09-08",
        date: "Sep 8–11, 2026 — Wuhan business trip",
        body:
          "Sep 8 (Tue) — Flew about two hours and arrived at Wuhan Tianhe Airport around 10 pm. Took Metro Line 2 to Jianghan Road and checked into the Jiangtan Haobainian Meilun Hotel; settled in by 11:30 pm and rested at midnight, ready for the busy official schedule ahead.\n\nSep 9 (Wed) — Official visits, project reviews and city sightseeing. Up early, and at 8:50 I drove with Wuhan Huayang colleague Xiao Liu to the Yujiatao Campus of Wuhan University of Technology to meet the Green Smart Shipping Alliance office. We successively visited Secretary Tang of the alliance, Vice Dean Ma of the School of Shipping, and Secretary Hou Jun. Both sides held in-depth discussions on mutual membership between Huayang Zhoushan Comprehensive Maritime Service Alliance and the Green Smart Shipping Alliance, resource sharing, business coordination, and Huayang's recruitment and scientific-research cooperation in marine engineering and engine-room talent at WUT. We reached a number of cooperative understandings, laying a good foundation for later integrated development of maritime industry alliances and deeper university-enterprise cooperation. Secretary Hou Jun also presented me with a copy of the History of the WUT School of Shipping, which is very helpful for understanding the school's past and present.\n\nBecause the Haobainian Hotel room was dim, had no sunlight, and the air-conditioner was extremely noisy, I moved to the adjacent Ji Hotel. From 1 pm, at Changhang Building, I attended the two standard-project review meetings organised by the Inland Ship Standard Committee, taking part seriously in professional discussion and standard demonstration, and completing the day's technical review tasks by about 7 pm.\n\nAfter the evening work, I took Metro Lines 2 and 5 to the Yellow Crane Tower scenic area, climbed the tower to overlook the night panorama of the three Wuhan towns and the scenery along both banks of the Yangtze, feeling the city's style and historical heritage, and watched some performances. After the visit, I took a short walk along Jianghan Road Pedestrian Street and returned to the hotel to rest around 10 pm.\n\nSep 10 (Thu) — Annual meeting of the Standard Committee, technical seminar, and government-enterprise exchanges. Today I walked to Pier 23 and boarded the electric vessel Yangtze Glory. From 9 am to 4 pm I attended the annual meeting and technical seminar of the Inland Ship Standard Committee, listening throughout to keynote reports and speeches by Academician Yan Xinping, industry experts and responsible leaders. I systematically studied the latest technical standards, industry trends, policy directions and cutting-edge technical achievements in the inland shipping industry, further strengthening my professional reserves and broadening my industry vision, and laying groundwork for carrying out similar business and scientific research in the future.\n\nAt 7 am I quickly changed into swimwear and went to a swimming spot on the Yangtze near Pier 17, said to be very close to the place where Chairman Mao crossed the Yangtze. Several elderly lifeguards were on duty there; they were very warm and showed me where to change, and recommended sandals and a life ring. I climbed over the fence and swam 300 metres in the designated swimming area, personally feeling the pleasure and fun of swimming in the Yangtze. The water quality was excellent, and the current was quite strong in places. After swimming I took a shower, which was very comfortable.\n\nAt 4 pm I specially visited Comrade Lu Xinhua at the Changjiang Shipping Administration; we reminisced about old times and exchanged views on our current work and industry developments — the conversation was smooth and rewarding. At 5 pm, at Wuhan Huayang, I received Director Lin Chengzhi of the Changjiang Maritime Safety Administration and gave him a detailed introduction to Wuhan Huayang's overall operations, business layout, team building and the current state of maritime service business development, completing a special work report and government-enterprise exchange. In the evening I joined Wuhan colleagues for a simple reception dinner with Director Lin, Director Guoguang, Director Zhao of the Pilot Station, Director Li, Director Zhang and others, returning to the hotel to rest around 10 pm.\n\nSep 11 (Fri) — Exercise, cultural visit and return to Beijing. Up at 7 am, a simple breakfast, then Metro Lines 2, 4 and 8 to the north side of East Lake for a long aerobic workout. From Chufengyuan Greenway on the north side of East Lake, I ran all the way south to the Moshan scenic area (the Moshan cable car was not open, otherwise I would have liked to take it up), a total of 8 km, then cycled nearly 14 km around the lake, passing Wuhan University and other places along greenways without backtracking — body and mind both relaxed.\n\nAfter the ride, I went to the Hubei Provincial Museum. Although I had not made a reservation, the ticket seller told me I could make a standby reservation, and fortunately it worked. I spent an hour and a half in the museum, systematically visiting all eight halls in the north and south buildings, including the Zeng state, the 800-year Chu kingdom, modern Hubei, ancient Hubei, the ceramics exhibition and the chime-bells exhibition, focusing on key national treasures and feeling the depth of Jing-Chu history and culture, while also balancing physical recuperation with cultural learning.\n\nAfter the visit ended at 12:20 pm, I took Metro Lines 8, 4 and 2 several times back to the Ji Hotel, quickly packed my luggage, and at 1:30 pm took Metro Line 2 to Wuhan Tianhe Airport for the flight back to Beijing. In the airport lounge I ate Wuhan hot dry noodles, spicy beef noodles, wood-ear fungus and other cold dishes, drank a small can of beer, and hurried to Gate 61 to board — very tight. The return flight took about an hour and a half (much faster than the outbound), and I arrived smoothly at Capital Airport at 6 pm. Driver Wang picked me up, and I arrived home safely at 6:40 pm, successfully concluding this Wuhan business trip.\n\nThis Wuhan trip yielded abundant official results and rich industry gains, while I also kept up regular exercise and a balance between work and rest, efficiently completing all work tasks and study-exchange arrangements.",
      },
    ],
  },
];
